...
```{r}
enriched <- read.csv("1_assemblednew/assemble_result_supp/enriched_gene.csv")
...
2. Retain genes represented in 50% of samples, 49 or greater to keep close to 1000 genes retained
