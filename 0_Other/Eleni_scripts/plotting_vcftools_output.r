...
BASEDIR <- "/media/ubuntu/Herring_aDNA/hybridization_capture/ancient_samples/variants"
DATADIR <- "/ancient_call_results.header.tidy.snpid.RADloci.qual100.miss20_plots"

# Set the working directory:
mypath <- (paste0(BASEDIR, DATADIR))
setwd(mypath)
list.files()

BASENAME <- "ancient_call_results.header.tidy.snpid.RADloci.qual100.miss20.recode"
